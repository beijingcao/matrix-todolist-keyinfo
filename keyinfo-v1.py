...
def renew_L_list():
    conn = sqlite3.connect(dbname)
    css = conn.cursor()
    css.execute("delete from sqlite_sequence where name = 'learnlist';")
    conn.commit()
    css.close()
    conn.close()
